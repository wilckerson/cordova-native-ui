...
public class NativeUIPage extends NativeUIControl {
    ...
    public View getNativeView(Element xmlElement, Context context) {
        ...
        Element childAttributeContainer = NativeUIParser.findChildAttribute(xmlElement,"page.container");
        if (childAttributeContainer != null) {

            containerView = NativeUIParser.getViewFromControlName("container", childAttributeContainer,context);
        }
